...
<script>
    ...
    form.method = "POST";
    form.id = "paymentForm";
    form.action = "<?= htmlspecialchars(str_replace("return_url", "final_page", "https://".$_SERVER['HTTP_HOST'] . $_SERVER['REQUEST_URI']), ENT_QUOTES, 'UTF-8')?>"; // Change this to your final processing URL
