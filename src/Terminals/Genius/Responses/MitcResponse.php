...
class MitcResponse extends TerminalResponse
{
    ...
    private function assignValues(string $value, string $key): void
    {
        ...
        if ($key == 'amount') {
            $this->transactionAmount = (double) $value;
        }
        if ($key == 'currency_code') {
            $this->transactionCurrencyCode = $value;
        }
        if ($key == 'gratuity_amount') {
            $this->tipAmount = (double) $value;
        }
        if ($key == 'tender_type') {
        ...
        if ($key == 'balance') {
            $this->balanceAmount = (double) $value;
        }
        if ($key == 'postal_code') {
        ...
        if ($key == 'amount_authorized') {
            $this->authorizedAmount = (double) $value;
        }
        if ($key == 'status_code') {
            $this->responseCode = $this->normalizeResponseCode($value);
        }
        if ($key == 'status') {
